...
const tooltip = clsx(
  ...
  "w-[14rem] rounded-xl border border-slate-700/80",
  "bg-slate-950/95 px-4 py-3",
  "text-slate-200 shadow-lg pointer-events-auto",
  "backdrop-blur",
);

const open = clsx("animate-tooltip-in");

const closing = clsx("animate-tooltip-out");
